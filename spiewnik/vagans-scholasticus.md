...
scores:
  - /assets/images/spiewnik/nuty/vagans-scholasticus-1.png
  - /assets/images/spiewnik/nuty/vagans-scholasticus-2.png
lyrics: |
  1. Już pieśni umilkły, hulanki ścichł gwar,
  Sam jeden znów błądzę wśród burz.
  |: Świat chwieje się, w wichrach posępny jęk mar,
  Spienione rwą fale do mórz! :|

  2. Niejedna gwiazdeczka, co piła wśród chmur,
  Już tacza się, runie gdzieś w głąb…
  |: Ja stoję jak kolos, nieschwiany, jak mur,
  Potężny, ogromny jak dąb! :|

  3. Tak błądzę w ulicach, już świta błysk dnia,
